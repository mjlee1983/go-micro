...
const defaultRepo = "github.com/mjlee1983/go-micro/go-micro/services"
...
func (s *Source) RuntimeName() string {
	if s.Repo == "github.com/mjlee1983/go-micro/go-micro/services" || s.Repo == "" {
		return s.Folder
	}
...
func ParseSource(source string) (*Source, error) {
	...
	if !strings.Contains(source, "github.com") {
		source = "github.com/mjlee1983/go-micro/go-micro/services/" + source
	}
